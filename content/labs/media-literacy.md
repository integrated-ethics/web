...
-   [worksheet](media-literacy-worksheet/)
    -   [Markdown](https://raw.githubusercontent.com/integrated-ethics/web/main/content/labs/media-literacy/media-literacy-worksheet.md)
-   [courtroom analogy](courtroom-analogy/)
    -   [Markdown](https://raw.githubusercontent.com/integrated-ethics/web/main/content/labs/media-literacy/courtroom-analogy.md)
...
-   Instructor analysis of student responses: ⩾15 min (depends on size of
    class).
...
**Ethical issues to be considered**: Media Literacy, Transparency,
...
-   Instructor augments those guidelines as necessary.
...
This can be done as homework or activity completed in previous
class. 
The important thing is the students complete the assignment 
prior to the class discussion so that the instructor can
read student answers.

#### Notes to instructor 

<!-- on the pre-discussion assignment -->
...
The second article is written by an author representing 
*Consumer Reports*, a reputable review company. 
The article gives pros and cons of both of the options. 
Some students felt that because the article gave both sides, 
it would have been enough to read. Both articles were
...
It is probably a good idea to make the analogous
...
Rank the witness sets from 1 (best) to 6 (worst). Be
...
1. We expect that students will disagree, and that is OK. 
    ...
    The goal is to get them to think, to articulate and to support their choices,
    and perhaps to hear another opinion.
...
3. After discussing the analogy, ask students how choosing articles is
...
-   As a class, students and instructor define a set of guidelines for
    credible articles/authors based on the analogy and the reading.

#### Notes to the instructor 

Experts on media literacy ask researchers
